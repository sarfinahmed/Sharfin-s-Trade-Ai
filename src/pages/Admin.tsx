...
import { Users, CreditCard, Settings, Activity, Trash2, CheckCircle, XCircle, Shield, ShieldOff, Save } from 'lucide-react';

export default function Admin() {
  const [activeTab, setActiveTab] = useState<'users' | 'requests' | 'history' | 'settings'>('users');
